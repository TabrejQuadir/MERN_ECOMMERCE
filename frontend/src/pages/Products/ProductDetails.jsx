...
const ProductDetails = () => {
  ...
  return (
    <div className="container mx-auto px-3 pb-8 relative">
       <Link to="/" className=" text-white font-bold transition-colors duration-300 flex items-center hover:text-yellow-300 hover:underline">
     <div className=" flex justify-between items-center bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500  p-3 rounded-2xl shadow-2xl transform hover:scale-105 transition-transform duration-300 absolute z-50 top-10 overflow-hidden">
        <FaArrowLeft className="mr-2 animate-pulse text-orange-400" />
        Go Back
    </div>
    </Link>
